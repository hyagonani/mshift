      ...
      <header className="fixed top-0 left-0 right-0 z-40 bg-background-dark/95 backdrop-blur-md border-b border-white/10 h-16 flex items-center">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2 group">
            <span className="font-serif font-extrabold text-2xl tracking-tight text-gradient-gold">MShift</span>
            <span className="text-[10px] uppercase font-bold tracking-widest text-slate-400 bg-white/5 px-2 py-0.5 rounded border border-white/10">
              Consultoria
            </span>
          </Link>
